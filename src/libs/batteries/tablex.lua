...
---@param i integer
---@return any
function table.swap_and_pop(t, i)
	table.swap(t, i, #t)
	return table.pop(t)
end
...
---@return table
function table.rotate(t, amount)
	if #t > 1 then
		while amount >= 1 do
			table.push(t, table.shift(t))
			amount = amount - 1
		end
		while amount <= -1 do
			table.unshift(t, table.pop(t))
			amount = amount + 1
		end
	end
	return t
...
---@param less function
---@return boolean
function table.is_sorted(t, less)
...
---@param less function
---@return table
function table.insert_sorted(t, v, less)
	less = less or default_less
	local low = 1
	local high = #t
	while low <= high do
...
---@param v any
---@return any
function table.next_element(t, v)
...
---@param v any
---@return any
function table.previous_element(t, v)
	local i = table.index_of(t, v)
	--not present? just get the front of the table
	if not i then
		return table.front(t)
...
---@param r function
---@return integer
function table.random_index(t, r)
	if #t == 0 then
		return 0
	end
...
function table.pick_random(t, r)
	...
	return t[table.random_index(t, r)]
end
...
function table.take_random(t, r)
	...
	return table.remove(t, table.random_index(t, r))
end
...
function table.pick_weighted_random(t, w, r)
	if #t == 0 then
		return nil
	end
	if #w ~= #t then
...
function table.compact(t, range)
	local r = {}
...
if not table.clear then
	...
	imported, table.clear = pcall(require, "table.clear")
...
---@param ... table
---@return table
function table.shallow_overlay(dest, ...)
...
table.overlay = table.shallow_overlay
...
-- overlays them in passed order onto the first,
-- and returns the first table.
function table.deep_overlay(dest, ...)
...
function table.shallow_equal(a, b)
	if a == b then
		return true
	end
...
function table.unpack2(t)
	return t[1], t[2]
end

function table.unpack3(t)
	return t[1], t[2], t[3]
end

function table.unpack4(t)
	return t[1], t[2], t[3], t[4]
end

function table.unpack5(t)
	return t[1], t[2], t[3], t[4], t[5]
end

function table.unpack6(t)
	return t[1], t[2], t[3], t[4], t[5], t[6]
end

function table.unpack7(t)
	return t[1], t[2], t[3], t[4], t[5], t[6], t[7]
end

function table.unpack8(t)
